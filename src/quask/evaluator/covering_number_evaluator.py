...
class CoveringNumberEvaluator(KernelEvaluator):
    """Covering number evaluator.
    
    Expressibility measure based on the covering number associated
    with the hypothesis class related to the current ansatz.
    See: Du, Yuxuan, et al. "Efficient measure for the expressivity of 
    variational quantum algorithms." Physical Review Letters
    128.8 (2022): 080506.
    """
