...
class ReinforcementLearningOptimizer(BaseKernelOptimizer):
    ...
    def __init__(
        ...
        self.y = y
        self.ke = ke
        self.mdp = Environment.make(
            "WideKernelEnvironment",
    ...
    def optimize(
        ...
        # Agent
        self.agent = SARSALambda(
            self.mdp.info, pi, learning_rate=learning_rate, lambda_coeff=0.9
        )
        ...
        # Train
        self.core.learn(
            n_episodes=n_episodes, n_steps_per_fit=n_steps_per_fit, render=True
        )
